        ...
        for (K=1; K<=30; K++)
        {
            ...
            while(t<=500)
            {
                ...
                }else if (video < Tong_video-1)  // chon video it buffer nhat de buffer
                {
                    ...
                    for(int i=video+3; (i <= video+K)&&(i < Tong_video); i++)
                    {
                ...
                }else
                {
                    ...
                    }else if(Buf[video+1] < Bseg && video < Tong_video - 1 ) // buffer video tiep theo
                    {
                        v=0;
                        while(1)
                        {
                    ...
                    }else if(Buf[video+a] < 1 && video < Tong_video - 2 ) // buffer video tiep theo
                    {
                        v=0;
                        while(1)
                        {
